...
function renderHeader() {
    ...
    header.innerHTML = `
            <div class="container mx-auto px-4 h-full flex items-center justify-between">
                ...
                <nav class="hidden lg:flex items-center gap-8" aria-label="Menu Principal Desktop">
                    <ul class="flex gap-2">
                        <li><a href="${config.basePath}emergencia.html" class="btn btn-ghost btn-sm text-red-500 font-bold">Emergência</a></li>
    ...
    if (!navMenu) {
        ...
        navMenu.innerHTML = `
            ...
            <a href="${getLink('servicos.html')}" class="btn btn-ghost w-full justify-start text-lg font-bold ${config.activePage === 'services' ? 'nav-mobile-link--active' : ''}" aria-label="Ir para Página de Serviços">Serviços</a>
